...
void ProductDetailDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProductDetailDialog::*)(const Product & )>(_a, &ProductDetailDialog::addToCart, 0))
            return;
    }
}
...
// SIGNAL 0
void ProductDetailDialog::addToCart(const Product & _t1)
{
