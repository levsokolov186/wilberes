...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->productsChanged(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DataManager::*)()>(_a, &DataManager::userChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DataManager::*)()>(_a, &DataManager::productsChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void DataManager::userChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DataManager::productsChanged()
{
