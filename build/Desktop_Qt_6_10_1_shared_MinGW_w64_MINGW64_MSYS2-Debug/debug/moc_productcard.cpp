...
#include "../../../include/ui/productcard.h"
...
void ProductCard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->productClicked((*reinterpret_cast<std::add_pointer_t<Product>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProductCard::*)(const Product & )>(_a, &ProductCard::addToCartClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ProductCard::*)(const Product & )>(_a, &ProductCard::productClicked, 1))
            return;
    }
}
...
// SIGNAL 1
void ProductCard::productClicked(const Product & _t1)
{
